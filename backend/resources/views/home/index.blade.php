...
<footer class="text-left pb-3 sticky-bottom bg-white">
    ...
    <div class="mt-3 d-flex">
        <input type="text" name="email" value="" class="form-control me-1 rounded-pill" id="home-words" placeholder="検索ワード">
        <input type="hidden" name="email" value="all" id="home-mode">
        <input type="button" name="リセット" class="btn btn-outline-secondary rounded-pill me-1 col-lg-1" onClick="clickResetButtonHome()">
        <input type="button" name="検索" class="btn btn-outline-primary rounded-pill col-lg-1" onClick="clickSearchButtonHome()">
    </div>
</footer>
