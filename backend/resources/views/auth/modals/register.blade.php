    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="modal-body mb-0" id="register-form">
                ...
                <div>
                    {!! Form::password('register_onetime_password', ['id' => 'register_onetime_password', 'class' => 'form-control input-field', 'placeholder' => 'ワンタイムパスワード']) !!}
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-primary btn-sm rounded-pill" onClick="clickRegisterButton()">登録</button>
            </div>
        </div>
    </div>
</div>
